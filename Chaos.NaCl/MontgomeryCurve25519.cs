...
namespace Chaos.NaCl
{
    ...
    public static class MontgomeryCurve25519
    {
        ...
        public static void KeyExchangeOutputHashCurve25519Paper(byte[] sharedKey, int offset)
        {
            //c = Curve25519output
        ...
        public static void KeyExchangeOutputHashNaCl(byte[] sharedKey, int offset)
        {
        ...
        public static void KeyExchange(ArraySegment<byte> sharedKey, ArraySegment<byte> publicKey, ArraySegment<byte> privateKey)
        {
            ...
            //Don't hash my points bro.. makes multi-party keys possible. but don't forget to has the key!
